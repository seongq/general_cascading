...
if __name__ == '__main__':
     ...
     if args.no_wandb:
          ...
          if ode_class.__name__ == "FLOWMATCHING":
               name_save_dir_path = f"dataset_{dataset}_sigma_min_{args.sigma_min}_sigma_max_{args.sigma_max}_T_rev_{args.T_rev}_t_eps_{args.t_eps}_num_flows_{args.num_flows}_num_timepts_{args.num_timepts}"
               logger = WandbLogger(project=f"GENERALCASCADING_FLOW", log_model=True, save_dir="logs", name=name_save_dir_path)
