...
class FLOWMATCHING(ODE):
    ...
    def add_argparse_args(parser):        
        parser.add_argument("--sigma-min", type=float, default=0.0, help="The minimum sigma to use. 0.05 by default.")
        parser.add_argument("--sigma-max",type=float, default=0.5 , help="The maximum sigma to use. 1 by default") 
        parser.add_argument("--T_sampling",type=float, default=1.0)
        return parser

    def __init__(self, sigma_min=0.0, sigma_max =0.5, T_sampling=1.0,**ignored_kwargs):
